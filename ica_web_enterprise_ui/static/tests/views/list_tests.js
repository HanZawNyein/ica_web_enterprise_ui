...
import { patchListRendererDesktop } from "@ica_web_enterprise_ui/views/list/list_renderer_desktop";
import { doAction, getActionManagerServerData } from "@web/../tests/webclient/helpers";
import { createEnterpriseWebClient } from "@ica_web_enterprise_ui/../tests/helpers";
import { registry } from "@web/core/registry";
import { homeMenuService } from "@ica_web_enterprise_ui/webclient/home_menu/home_menu_service";
import { enterpriseSubscriptionService } from "@ica_web_enterprise_ui/webclient/home_menu/enterprise_subscription_service";

let config;
let serverData;
let target;
QUnit.module(
    "ica_web_enterprise_ui",
    {
        beforeEach() {
            target = getFixture();
            config = {
